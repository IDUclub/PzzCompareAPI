...
| `pzz_descriptions_file` | file | – | Описания зон → разрешённые ВРИ. Две схемы: числовая `{ "functional_zone_mappings": [...] }` (для числового `functional_zone_type_id`) и буквенная — список `[{ "zone_code": "Ж-1", "main": [...] }]` (для индексов ПЗЗ). Без файла — встроенный маппинг/шаблон |
